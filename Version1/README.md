# Crypto Display V1 — Raspberry Pi (C++ / Raylib)

> Part of [CryptoDisplay](../README.md). This is the original native version; see [Version 2](../Version2/README.md) for the XIAO Trigger version.
...
![Example Display](../docs/v1-screenshot.png)
...
├── config.json             # Example config (copy onto the CRYPTOS USB)
...
2. **IMPORTANT**: Unzip and retrieve `Version1` folder, and place that on Raspberry Pi Desktop. Structure of this folder should follow structure above.
   - path must be: `/home/pi/Desktop/Version1/`
...
Navigate to the project directory `/home/pi/Desktop/Version1/`, and then enter these commands:
...
```bash
chmod +x ~/Desktop/Version1/sentry.sh
```
...
```bash
   ...
   Exec=/home/pi/Desktop/Version1/sentry.sh
   Terminal=false
```
...
```bash
   ls -l /home/pi/Desktop/Version1/sentry.sh
```
